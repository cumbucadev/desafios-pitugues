...
## 💬 Sobre o Repositório
Este repositório é voltado para abrigar desafios de programação na linguagem Pituguês, incentivando o aprendizado de algoritmos e oferecendo um espaço aberto para trocas e conversas.

Você pode encontrar os desafios e suas devidas descrições na aba de [issues][github-issues]!

Se sentir à vontade, pode contribuir com o projeto criar novas issues de desafios também.
